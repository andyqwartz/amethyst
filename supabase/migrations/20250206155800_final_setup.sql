...
DROP FUNCTION IF EXISTS handle_ad_view(UUID, TEXT, INTEGER, TEXT);
DROP FUNCTION IF EXISTS is_admin(UUID);
DROP FUNCTION IF EXISTS create_profile_on_signup();
DROP FUNCTION IF EXISTS reset_daily_ad_counts();
DROP FUNCTION IF EXISTS create_admin_user(TEXT, TEXT);
DROP FUNCTION IF EXISTS notify_credit_change();
