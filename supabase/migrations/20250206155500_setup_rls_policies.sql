...
DROP POLICY IF EXISTS "Users can insert their own reference images" ON public.reference_images;
DROP POLICY IF EXISTS "Users can view their own transactions" ON public.credit_transactions;
DROP POLICY IF EXISTS "System can insert transactions" ON public.credit_transactions;
DROP POLICY IF EXISTS "Users can view their own ad views" ON public.ad_views;
DROP POLICY IF EXISTS "Users can insert their own ad views" ON public.ad_views;
DROP POLICY IF EXISTS "Users can view image metadata" ON public.image_metadata;
DROP POLICY IF EXISTS "System can insert image metadata" ON public.image_metadata;
DROP POLICY IF EXISTS "Admins have full access to all tables" ON public.images;
DROP POLICY IF EXISTS "Admins have full access to image metadata" ON public.image_metadata;
DROP POLICY IF EXISTS "Admins have full access to credit transactions" ON public.credit_transactions;
DROP POLICY IF EXISTS "Admins have full access to ad views" ON public.ad_views;
