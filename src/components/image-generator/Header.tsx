  ...
  return (
    <div className="relative flex justify-center items-center mb-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-6xl font-bold font-outfit bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent bg-[length:200%] animate-[gradient_8s_linear_infinite] tracking-tight">
          Amethyst
        </h1>
      </div>
      ...
      >
        ...
        >
          ...
          <HelpCircle className="h-6 w-6 text-primary relative z-10" />
        </Button>
      </div>
    </div>
  );
