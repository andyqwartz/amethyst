...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 left-0 right-0 flex items-center justify-center p-4 gap-4",
      "flex-col z-[100] w-full",
      className
    )}
    {...props}
  />
